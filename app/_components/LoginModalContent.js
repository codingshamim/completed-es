      ...
      <div className="bg-black rounded-2xl overflow-hidden shadow-2xl border border-gray-800">
        ...
        <div className="p-10 pt-6">
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/login"
              className="w-full bg-black hover:bg-secondary hover:border-transparent text-white  py-4 px-6 rounded-xl flex items-center justify-center gap-3 transition-all duration-200  active:scale-95 border border-gray-700 hover:border-gray-600  "
            >
              <svg
                className="w-6 h-6"
                fill="none"
              ...
              <span className="text-base">Login with Phone Number</span>
            </Link>
          </div>
