...
export default function AddCart({ quantity, productId, size }) {
  ...
  return (
    <SecondaryLoadingBtn
      loading={loading}
      onClick={handler}
      className="py-2  w-full md:w-max justify-center flex items-center  gap-1 px-4 font-medium active:scale-[98%] transition-all duration-300 rounded-sm new-variable-btn hover:border-transparent nav-border text-white text-sm"
    >
      <svg
